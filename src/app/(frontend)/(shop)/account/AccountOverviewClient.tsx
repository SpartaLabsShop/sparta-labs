    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-4xl font-bold text-[#CC292B] mt-1">Kyle</h1>
        </div>
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 bg-white border border-slate-200 px-4 py-2.5 rounded-xl shadow-sm">
            <CreditCard size={18} className="text-[#CC292B]" />
            <span className="text-sm font-bold text-[#CC292B]">$0.00</span>
          </div>
      ...
      <motion.div variants={itemVars} className="relative bg-[#FFF5F5] rounded-3xl overflow-hidden border border-[#FFEBEB]">
        ...
        <div className="absolute right-0 top-0 bottom-0 w-1/2 hidden md:block">
           <img src="/partner-graphic.png" alt="" className="absolute inset-0 w-full h-full object-cover object-left" />
        </div>
      </motion.div>
